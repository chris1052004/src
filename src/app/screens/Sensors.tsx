  ...
  return (
    <div className="bg-white min-h-full">
      <div className="status-bar-aware px-4 pb-3 border-b border-neutral-200 bg-white flex items-center gap-3">
        ...
        <h1 className="text-[17px] font-semibold tracking-tight text-neutral-900">Sensors</h1>
      </div>
      <div className="flex flex-col items-center justify-center py-24 px-8 text-center">
        ...
        <p className="text-[13px] text-neutral-400 mt-1.5 leading-relaxed">Fitur Sensors akan hadir dalam pembaruan berikutnya.</p>
      </div>
    </div>
  );
}
