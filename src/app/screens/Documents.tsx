  ...
  return (
    <div className="bg-surface min-h-full">
      <div className="status-bar-aware px-4 pb-3 border-b border-divider bg-card flex items-center gap-3">
        ...
        <h1 className="text-[17px] font-semibold tracking-tight text-foreground">Documents</h1>
      </div>
      <div className="flex flex-col items-center justify-center py-24 px-8 text-center">
        <div className="w-16 h-16 rounded-2xl bg-sky-50 dark:bg-sky-500/15 flex items-center justify-center mb-4">
        ...
        <p className="text-[13px] text-muted-foreground mt-1.5 leading-relaxed">Fitur Documents akan hadir dalam pembaruan berikutnya.</p>
      </div>
    </div>
  );
}
